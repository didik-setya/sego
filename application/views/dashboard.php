...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Sistem Management Kost (SEGO) | <?= $title ?></title>
    <meta name="title" content="Sistem Management Kost (SEGO) | <?= $title ?>" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?= base_url() ?>" />
    <meta property="og:title" content="Sistem Management Kost (SEGO) | <?= $title ?>" />
    <meta property="og:image" content="<?= base_url() ?>assets/logo.jpg" />

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image" />
    <meta property="twitter:url" content="<?= base_url() ?>" />
    <meta property="twitter:title" content="Sistem Management Kost (SEGO) | <?= $title ?>" />
    ...
    <div id="wrapper" class="sidebar-toggled">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
                ...
                <div class="sidebar-brand-text mx-3"><?= $this->session->userdata('kost_name') ?></div>
            </a>
